...
```{r}
# Study patients
patients_list <- read.csv(paste0(path, "Biomarker\ 2/clad-bal-multiomics-bm2/analysis/backup/clinical-metadata/patients-selection.csv") )
...
```{r}
sheet_names <- readxl::excel_sheets(paste0(path, "Biomarker\ 2/immunosuppression-analysis/immunosuppression-table.xlsx"))
xlsx <- readxl::read_xlsx(paste0(path, "Biomarker\ 2/immunosuppression-analysis/immunosuppression-table.xlsx"))
...
for (i in sheet_names){
  table_list[[i]] <- readxl::read_xlsx(paste0(path, "Biomarker\ 2/immunosuppression-analysis/immunosuppression-table.xlsx"), sheet = i ) %>%
    mutate(Record.ID = i,
...
saveRDS(immunosuppression_list, paste0(path, "Biomarker\ 2/immunosuppression-analysis/immunosuppression-list.rds") )
```
...
ggplot(aes(x = Days, y = tacrolimus_level)) +
